...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Fire and Lighting Demo");
    glewInit();
    try
	{
		init();
...
int init()
{
	...
	else if(choice == 5)
	{
		...
		cubemapFlame->ambColor = glm::vec4(0.7f, 0.7f, 0.9f, 1.0f);

		cubemapFlame->setIntensity(2.31f);
		cubemapFlame->setAmbIntensity(0.01f);
	}
